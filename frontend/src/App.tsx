    ...
    <div className="app">
      ...
      <section className="hero">
        <div>
          ...
          <p className="hero-copy">
            Chon so nguoi choi, dat mat khau tuy chon, va san sang danh Tien
            Len voi ban be trong vai giay.
          </p>
      ...
      <section className="lobby-grid">
        <form className="panel" onSubmit={handleCreate}>
          ...
          <label>
            Ten nguoi choi
            <input placeholder="VD: Minh, An, Linh" required />
          </label>
          <label>
            So luong nguoi choi
        ...
        <form className="panel highlight" onSubmit={handleJoin}>
          ...
          <label>
            Ten nguoi choi
            <input placeholder="VD: Huy, Phuong" required />
          </label>
          <label>
            Ma phong
